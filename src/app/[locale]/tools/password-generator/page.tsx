...
export async function generateMetadata({
  ...
  const title = t("passwordGenerator.title");
  const description = t("passwordGenerator.description");
  const url = `/${locale}/tools/password-generator`;
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://easytoolhub.com";

  return {
    title,
    description,
    keywords: ["password generator", "online tool", "free calculator", "EasyToolHub", "security"],
