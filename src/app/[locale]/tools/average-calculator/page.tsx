...
export async function generateMetadata({
  ...
  const title = t("averageCalculator.title");
  const description = t("averageCalculator.description");
  const url = `/${locale}/tools/average-calculator`;
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://easytoolhub.com";

  return {
    title,
    description,
    keywords: ["average calculator", "online tool", "free calculator", "EasyToolHub", "math"],
