...
export async function generateMetadata({
  ...
  const title = t("dueDateCalculator.title");
  const description = t("dueDateCalculator.description");
  const url = `/${locale}/tools/due-date-calculator`;
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://easytoolhub.com";

  return {
    title,
    description,
    keywords: ["due date calculator", "online tool", "free calculator", "EasyToolHub", "time"],
