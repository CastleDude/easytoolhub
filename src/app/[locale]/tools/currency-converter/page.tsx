...
export async function generateMetadata({
  ...
  const title = t("currencyConverter.title");
  const description = t("currencyConverter.description");
  const url = `/${locale}/tools/currency-converter`;
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://easytoolhub.com";

  return {
    title,
    description,
    keywords: ["currency converter", "online tool", "free calculator", "EasyToolHub", "finance"],
