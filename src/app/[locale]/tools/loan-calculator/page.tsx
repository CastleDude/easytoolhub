...
export async function generateMetadata({
  ...
  const title = t("loanCalculator.title");
  const description = t("loanCalculator.description");
  const url = `/${locale}/tools/loan-calculator`;
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://easytoolhub.com";

  return {
    title,
    description,
    keywords: ["loan calculator", "online tool", "free calculator", "EasyToolHub", "finance"],
