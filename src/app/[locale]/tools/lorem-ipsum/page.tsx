...
export async function generateMetadata({
  ...
  const title = t("loremIpsum.title");
  const description = t("loremIpsum.description");
  const url = `/${locale}/tools/lorem-ipsum`;
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://easytoolhub.com";

  return {
    title,
    description,
    keywords: ["lorem ipsum", "online tool", "free calculator", "EasyToolHub", "text"],
