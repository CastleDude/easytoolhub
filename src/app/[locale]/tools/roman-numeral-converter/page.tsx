...
export async function generateMetadata({
  ...
  const title = t("romanNumeral.title");
  const description = t("romanNumeral.description");
  const url = `/${locale}/tools/roman-numeral-converter`;
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://easytoolhub.com";

  return {
    title,
    description,
    keywords: ["roman numeral converter", "online tool", "free calculator", "EasyToolHub", "utility"],
